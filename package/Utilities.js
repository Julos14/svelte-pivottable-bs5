...
const aggregatorsFR = ((tpl) => ({
    'Comptage': tpl.count(usFmtInt),
    'Comptage des valeurs uniques': tpl.countUnique(usFmtInt),
    'Liste des valeurs uniques': tpl.listUnique(', '),
    'Somme': tpl.sum(usFmt),
    'Somme entière': tpl.sum(usFmtInt),
    ...
    'Somme sur Somme': tpl.sumOverSum(usFmt),
    'Somme en tant que fraction du total': tpl.fractionOf(tpl.sum(), 'total', usFmtPct),
    'Somme en fraction de lignes': tpl.fractionOf(tpl.sum(), 'row', usFmtPct),
...
const locales = {
    ...
    fr: {
        aggregators: aggregatorsFR,
        localeStrings: {
            renderError: 'Une erreur s\'est produite lors du rendu des résultats du tableau croisé dynamique.',
            computeError: 'Une erreur s\'est produite dans le calcul des résultats du tableau croisé dynamique.',
            uiRenderError: 'Une erreur s\'est produite lors de l\'affichage de l\'interface utilisateur du tableau croisé dynamique.',
            selectAll: 'Sélectionner Tout',
            select: 'Sélectionner',
            deselect: 'Désélectionner',
            selectNone: 'Sélectionner Aucun',
            tooMany: '(trop nombreux pour être énumérés)',
            filterResults: 'Valeurs des filtres',
            apply: 'Appliquer',
            cancel: 'Annuler',
            totals: 'Totaux',
            vs: 'vs',
...
class PivotData {
    ...
    getLocaleStrings() {
        return locales[this.props.lang].localeStrings;
    }
}
